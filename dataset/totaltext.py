'''
This code is to build data loader for Total-Text dataset.
'''
...
class PAN_TT(data.Dataset):
    ...
    def prepare_train_data(self, index):
        ...
        for i, word in enumerate(words):
            ...
            gt_words[i + 1] = gt_word # be aware of i + 1 instead of i
            word_mask[i + 1] = 1
...
if __name__ == '__main__':
    ...
    train_dataset = PAN_TT(split='train',
                           is_transform=False,
                           img_size=None,
                           short_size=640,
                           kernel_scale=0.7,
    ...
    test_dataset = PAN_TT(split='test',
                          is_transform=False,
                          img_size=None,
                          short_size=640,
                          kernel_scale=0.7,

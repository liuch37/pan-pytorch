'''
This code is to build data loader for synthtext dataset.
'''
...
def shrink(bboxes, rate, max_shr=20):
    rate = rate * rate
    shrinked_bboxes = []
    for bbox in bboxes:# Replace ply.Polygon with simple area calculation function  
...
if __name__ == '__main__':
    ...
    train_dataset = PAN_Synth(is_transform=False,
                              img_size=None,
                              short_size=640,
                              kernel_scale=0.5,
                              with_rec=True)

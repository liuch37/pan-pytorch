'''
This code is to build data loader for MSRA-TD500 dataset.
'''
...
def shrink(bboxes, rate, max_shr=20):
    ...
    for bbox in bboxes:
        ...
        y = bbox[:,1]
        area = PolyArea(x,y)
        #area = plg.Polygon(bbox).area() # replaced
        peri = perimeter(bbox)
...
if __name__ == '__main__':
    ...
    train_dataset = PAN_MSRA(split='train',
                             is_transform=False,
                             img_size=None,
                             short_size=736,
                             kernel_scale=0.5,
    ...
    test_dataset = PAN_MSRA(split='test',
                            is_transform=False,
                            img_size=None,
                            short_size=736,
                            kernel_scale=0.5,
